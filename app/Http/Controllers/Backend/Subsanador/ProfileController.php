...
namespace App\Http\Controllers\Backend\Subsanador;
...
class ProfileController extends Controller
{
    public function index(User $user)
    {
        ...
        return view('backend.subsanador.profile.profile-subsanador', compact('userProfile'));
    }


    public function update_password_subsanador(Request $request){
    ...
    public function photo_subsanador(Request $request)
