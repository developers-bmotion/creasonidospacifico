...
class ShowProjectController extends Controller
{
    public function index(Project $project)
    {
        ...
        $artist= Project::where('id',$project->id)->with('artists.users','artists.artistType','artists.personType','artists.beneficiary.documentType','artists.beneficiary.city','artists.beneficiary.expeditionPlace','artists.beneficiary.residencePlace.departaments','artists.teams','artists.teams.expeditionPlace','artists.teams.residencePlace.departaments','artists.expeditionPlace.departaments','artists.residencePlace.departaments')->first();
