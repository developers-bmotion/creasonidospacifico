...
<head>
    <meta charset="utf-8"/>
    <title>Crea Sonidos Pacifico | Reestablecer Contraseña</title>
    ...
    <div
        ...
        <div class="m-grid__item m-grid__item--order-tablet-and-mobile-2 m-login__aside">
            <div class="m-stack m-stack--hor m-stack--desktop">
                @if (session('status'))
                    <div class="alert alert-success" role="alert" style="font-weight: 500 !important;">
                        {{ session('status') }}
                    </div>
                @endif
                            ...
                            <form class="m-login__form m-form" method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group m-form__group">
                                    <input
                                        ...
                                        type="text" placeholder="Ingresa tu correo eléctronico" name="email"
                                        id="m_email"
                                        autocomplete="off">
                                    @if ($errors->has('email'))
                                ...
                                <div class="m-login__form-action">
                                    <button type="submit"
                                            class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Enviar
                                    </button>
                                    <a href="/login"
        ...
        <div
            class="background_reset_email m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1  m-login__content m-grid-item--center"
