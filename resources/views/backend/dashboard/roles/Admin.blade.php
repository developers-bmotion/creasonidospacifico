        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <ul class="nav nav-tabs  m-tabs-line m-tabs-line--2x m-tabs-line--success" role="tablist">
                    ...
                    <li class="nav-item m-tabs__item">
                        <a class="nav-link m-tabs__link" id="tab_champion" data-toggle="tab" href="#m_tabs_6_8" role="tab">Ganadores</a>
                    </li>
                </ul>
...
{{--                                Toggle column: <a class="toggle-vis" data-column="2">Actuara como</a> - <a class="toggle-vis" data-column="3">Categoría</a> - <a class="toggle-vis" data-column="4">Email</a> - <a class="toggle-vis" data-column="5">Departamento de nacimiento</a> - <a class="toggle-vis" data-column="6">Ciudad de nacimiento</a> - <a class="toggle-vis" data-column="7">Estado</a>- <a class="toggle-vis" data-column="8">Acciones</a>--}}
                    ...
                    {{-- tab para la segunda calificacion  --}}
...
<script>
        ...
        // var storeTipoProyecto = "storeTipoProyecto";
        // var tipoProyecto = getStorage(storeTipoProyecto);
        var tipoPerQualSec = 0;
        var categoryQualSec=0;


        var tableQuailifiedSec = null;

        const loadTableQualSec = function () {
            if (tableQuailifiedSec !== null) {
                tableQuailifiedSec.destroy();
            }
            var cont = 1;
            var cat;
            tableQuailifiedSec = $('#table_qualified_second').DataTable({
                "processing": true,
                "serverSide": true,
                "scrollX": true,
                "pageLength": 1000,
                ...
                "ajax": {
                    url: "{{route('list.ratings.second')}}",
                    data: {
                        tipoPerQualSec:tipoPerQualSec,
                        categoryQualSec:categoryQualSec
                    }
                },
                "columns": [
        ...
        // filtro por categoria
        $('#category_filter_cualified_sec').on('change', function(){
...
<script>
        ...
        const loadTableG = function () {
            if (tableG !== null) {
                tableG.destroy();
            }
            var cont = 1;
            var cat;
            tableG = $('#table_champion').DataTable({
                "processing": true,
                "serverSide": true,
                "scrollX": true,
                "pageLength": 1000,
        ...
        $("#tab_champion").on('click', function () {
...
<script>
        ...
        const loadTableEsc = function () {
            if (tableEsc !== null) {
                tableEsc.destroy();
            }
            var cont = 1;
            var cat;
            tableEsc = $('#table_esc').DataTable({
                "processing": true,
                "serverSide": true,
                "scrollX": true,
                "pageLength": 1000,
                ...
                "ajax": {
                    url: "{{route('list.finalist')}}",
                    data: {
                        tipoPerEsc:tipoPerEsc,
                        categoryEsc:categoryEsc
                    }
                },
                "columns": [
        ...
        // filtro por categoria
        $('#category_filter_esc').on('change', function(){
            categoryEsc = $(this).val();
            console.log(categoryFin,'cattCual');
            loadTableEsc();
               table.search(this.value).draw();
        });
        ...
        $("#tipoPersona_esc").on('change', function () {
            tipoPerEsc = $(this).val();
            console.log(tipoPerFin,'tipopercual');
            loadTableEsc();
        });

        $("#tab_esc").on('click', function () {
