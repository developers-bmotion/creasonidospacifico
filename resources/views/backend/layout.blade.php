...
{{--        @include('facebook-pixel::body')--}}
        ...
        <div class="m-grid m-grid--hor m-grid--root m-page" id="app">
                ...
                @if(auth()->user()->roles[0]->rol == "Artist" || auth()->user()->roles[0]->rol == "Manage" || auth()->user()->roles[0]->rol == "Gestor" || auth()->user()->roles[0]->rol == "Subsanador")
                    ...
                    <footer class="m-grid__item m-footer ">
                        ...
                        <span class="m-footer__copyright">
                            <span class="font-weight-bold">{{ config('app.name') }} </span> &copy; 2020 Powered by <a
                                href="https://bmotion.co" target="_blank" class="m-link">Bmotion SAS </a>
                        </span>
                                </div>
                                <div
                                    ...
                                    <ul class="m-footer__nav m-nav m-nav--inline m--pull-right">
                                        ...
                                        <li class="m-nav__item">
                                            <a href="https://creasonidos.com/terminos-y-condiciones" target="_blank"
                                               class="m-nav__link">
                                    ...
                                    <ul class="m-footer__nav m-nav m-nav--inline pt-2 pr-5">
                                        <li class="m-nav__item">
                                            <img width="110" src="/images/logos-patrocinadores/logo-presidencia.png"
                                                 alt="">
                                        </li>
                                        <li class="m-nav__item">
                                        ...
                                        <li class="m-nav__item">
                                            <img width="110" src="/images/logos-patrocinadores/logo-fundacion-yuri.png"
                                                 alt="">
                                        </li>
                                        <li class="m-nav__item">
                                            <img width="69" src="/images/logos-patrocinadores/fundacion-barco.png"
                                                 alt="">
                                        </li>
                                    </ul>
                                </div>
            ...
            <div id="m_quick_sidebar" class="m-quick-sidebar m-quick-sidebar--tabbed m-quick-sidebar--skin-light">
                <project-messages id="mensajeProjects"
                                  userJson="{{Auth::check()? Auth::user() : "{}" }}"></project-messages>
            </div>
            ...
            <ul class="m-nav-sticky" style="margin-top: 30px;background-color: #739594;">
                ...
                <li class="m-nav-sticky__item " data-toggle="m-tooltip" title="¿Necesitas Ayuda? Contáctanos"
                    data-placement="left">
                    <a href="https://creasonidos.com/contacto/" target="_blank"><i class="la la-question-circle"
                                                                                   style="color: white; !important;"></i></a>
                </li>
                <li class="m-nav-sticky__item pt-3" data-toggle="m-tooltip" title="Términos de Referencia"
                    data-placement="left">
                    <a href="/documents/Términos-de-refencia-Crea-Sonidos.pdf" target="_blank"><i class="la la-book"
                                                                                                  style="color: white; !important;"></i></a>
                </li>
                <li class="m-nav-sticky__item pt-3" data-toggle="m-tooltip" title="Preguntas Frecuentes"
                    data-placement="left">
                    <a href="/documents/PREGUNTAS_FRECUENTES_CON RESPUESTAS_26-10-2020_APROBADO.pdf" target="_blank"><i
                            class="la la-question-circle" style="color: white; !important;"></i></a>
                </li>
            ...
            <script src="/backend/vendors/bootstrap-timepicker/js/bootstrap-timepicker.min.js"
                    type="text/javascript"></script>
            ...
            <script src="/backend/vendors/js/framework/components/plugins/forms/bootstrap-daterangepicker.init.js"
                    type="text/javascript"></script>
            <script src="/backend/vendors/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js"
                    type="text/javascript">
            </script>
            <script src="/backend/vendors/bootstrap-maxlength/src/bootstrap-maxlength.js"
                    type="text/javascript"></script>
            ...
            <script src="/backend/vendors/inputmask/dist/inputmask/inputmask.phone.extensions.js"
                    type="text/javascript">
            </script>
            ...
            <script src="/backend/vendors/js/framework/components/plugins/charts/chart.init.js"
                    type="text/javascript"></script>
            ...
            <script src="/backend/assets/demo/custom/crud/forms/widgets/bootstrap-select.js"
                    type="text/javascript"></script>
        ...
        <!--end::Global Theme Bundle -->
            ...
            <script src="/backend/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js"
                    type="text/javascript"></script>
            <script src="/backend/assets/vendors/custom/datatables/datatables.bundle.js"
                    type="text/javascript"></script>
