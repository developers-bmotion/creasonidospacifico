...
@section('content')
    ...
    <!--=====================================
        ...
        <!--=====================================
                        ...
                        <div class="col-xl-8 offset-xl-2">
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub"
                                         style="text-align: justify; padding-top: 1.8rem;">
                                        <strong>Nota:</strong>
                                        Por favor ten presente que si un aspirante no cuenta con un correo electrónico,
                                        se debe dejar este campo sin llenar.
                                    </div>
            ...
            ======================================-->
            <div id="content-informacion-subir-cancion" style="display: none"
                 class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                        ...
                        <div class="col col-lg-12" style="padding: 0 2rem 1rem 2rem;">
                            ...
                            <div class="form-group m-form__group row">
                                <div id="content-song_nameProject" class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label" form="nombreProyecto">Nombre de la canción <span
                                            class="text-danger">*</span></label>
                                    <input id="nombreProyecto" type="text" name="song[nameProject]"
                                           class="form-control m-input" placeholder="" value="">
                                    <div id="error-song_nameProject" class="form-control-feedback"
                                         style="display: none"></div>
                                    <span class="m-form__help">{{ __('help_nombre_proyecto') }}</span>
                                </div>

                                <div id="content-song_author" class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label" form="nombreProyecto">Nombre del autor o
                                        compositor <span class="text-danger">*</span></label>
                                    <input type="text" name="song[author]" class="form-control m-input" placeholder=""
                                           value="">
                                    <div id="error-song_author" class="form-control-feedback"
                                         style="display: none"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-12 m-form__group-sub">
                                    <label class="form-control-label" form="nombreProyecto">Escriba aquí una breve
                                        reseña </label>
                                    <textarea id="exampleTextarea" name="song[description]" class="form-control m-input"
                                              rows="5"></textarea>
